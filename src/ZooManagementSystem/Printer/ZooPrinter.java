...
public class ZooPrinter {
	...
	public String printFishes() {
		...
		if (fishes == null)
			return "There are no Fishes in the Aquarium";
		...
		if (numberOfFishes > 0) {
			...
			for (int i = 0; i < fishes.size(); i++) {
				Fishes_D += (i + 1) + ")Type Of Fish: " + fishes.get(i).toString() + " Age: " + fishes.get(i).getAge()
						+ " Length: " + String.format("%.2f", fishes.get(i).getLength()) + " Pattern: "
						+ fishes.get(i).getPattern() + " Happiness: " + fishes.get(i).getHappiness() + ".\n";
	...
	public String printPenguins() {
		...
		if (penguins == null)
			return "There are no Penguins in the Zoo";
	...
	public String printLions() {
		...
		if (lions == null)
			return "There are no Lions in the Zoo";
	...
	public String printTigers() {
		...
		if (tigers == null)
			return "There are no Tigers in the Zoo";
	...
	public String printLynxes() {
		...
		if (lynxes == null)
			return "There are no Lynxes in the Zoo";
	...
	public String ListentoAllAnimalsinZoo(Zoo zoo) {
		...
		out += "1)Lions Noise: " + zoo.lionService.getAll().get(0).makeNoise() + "\n2)Tigers Noise: "
				+ zoo.tigerService.getAll().get(0).makeNoise() +
				"\n3)Penguins Noise: " + zoo.penguinService.getLeader().makeNoise() + "\n4)Fishes Noise: "
				+ zoo.fishService.getAll().get(0).makeNoise() +
				"\n5)Lynxes Noise: " + zoo.lynxService.getAll().get(0).makeNoise() + "\n6)Dogs Noise: "
				+ zoo.dogService.getAll().get(0).makeNoise();
		return out;
	}
