...
public class DogUI {
    ...
    public void handleAddNewDog(Scanner input) {
        ...
        // Asumsi genderChoice dan dogTypeChoice adalah integer yang dipahami oleh DogService
        // Jika Anda sudah membuat enum Gender dan DogType, sesuaikan bagian ini
        int genderChoice = InputUtil.promptIntInRange(input, "Enter the Gender of the new Dog:\n1) Male\n2) Female (Type 1 or 2)",
